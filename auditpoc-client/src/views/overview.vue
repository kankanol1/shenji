<template>
    <div class="layout">
        <div class="layout-content" :style="'height:'+height+'px'" id="copyCardArea" ref="copyCardArea">
...
<script>
    ...
    export default {
        mounted() {
            ...
            /*$.post('/api/graph/regBigGraph?type=2&size=10', function (data) {
            ...
            /*that.$http.post('/api/overviews/selectOverviewsNodesDetail?oper=1&page=0&size=10',function (data) {
                that.insertMiddleNodes(data.data);
                that.$refs.graph.cytoScapeGraph.hideLoading();
