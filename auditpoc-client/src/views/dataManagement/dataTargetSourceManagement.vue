...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            queryTypeList() {
                var that = this;
                that.$http.post("/api/datatarget/typelist", that.querystring.stringify({})
            ...
            queryStatusList() {
                var that = this;
                that.$http.post("/api/datatarget/statuslist", that.querystring.stringify({})
                ).then(function (response) {
                    if ((response.data.status & 1) == 1) {
            ...
            queryTagList() {
                var that = this;
                that.$http.post("/api/datatarget/taglist", that.querystring.stringify({})
                ).then(function (response) {
                    if ((response.data.status & 1) == 1) {
            ...
            queryDriverList() {
                var that = this;
                that.$http.post("/api/datatarget/driverlist", that.querystring.stringify({})
                ).then(function (response) {
                    if ((response.data.status & 1) == 1) {
            ...
            queryDataSourceList() {
                ...
                that.$http.post("/api/datatarget/selectNode", that.querystring.stringify(params)
                ).then(function (response) {
            ...
            checkValidity(formName) {
                if (this.addDataSourceForm) {
                    var that = this;
                    that.$http.post("/api/datatarget/checkValidity", that.querystring.stringify(that.addDataSourceForm)
                    ).then(function (response) {
                        if ((response.data.status & 1) == 1) {
                            setTimeout(function () {
                            }, 0);
            ...
            checkValidityUpdate(formName) {
                if (this.addDataSourceForm) {
                    var that = this;
                    that.$http.post("/api/datatarget/checkValidity", that.querystring.stringify(that.selectDataSourceForm)
                    ).then(function (response) {
                        if ((response.data.status & 1) == 1) {
                            setTimeout(function () {
                            }, 0);
            ...
            insertDataSource(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        if (this.addDataSourceForm) {
                            var that = this;
                            that.$http.post("/api/datatarget/insertNode", that.querystring.stringify(that.addDataSourceForm)
                            ).then(function (response) {
                                if ((response.data.status & 1) == 1) {
                                    setTimeout(function () {
            ...
            cloneDataSource(index) {
                ...
                var that = this;
                that.$http.post("/api/datatarget/cloneNode", that.querystring.stringify({
                        id: datasourceId,
                    })
                ).then(function (response) {
                    if ((response.data.status & 1) == 1) {
            ...
            updateDataSource(index) {
                if (this.selectDataSourceForm) {
                    var that = this;
                    that.$http.post("/api/datatarget/updateNode", that.querystring.stringify(that.selectDataSourceForm)
                    ).then(function (response) {
                        if ((response.data.status & 1) == 1) {
                            setTimeout(function () {
                                that.queryDataSourceList();
            ...
            sendDeleteDataSourceRequest(ids) {
                var that = this;
                that.$http.post("/api/datatarget/deleteNode", that.querystring.stringify({
                        ids: ids,
                    })
                ).then(function (response) {
                    if ((response.data.status & 1) == 1) {
