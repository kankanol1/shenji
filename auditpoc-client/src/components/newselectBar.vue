    ...
    <div id="selectPage" class="ivu-input-group-with-append" style="display: inline-flex;">
        ...
        <div style="width:153px" >
            ...
            <div style="float:left;" >
                <input id="sousu" style="height:30px;border-radius:5px;width:150px;" autocomplete="off"  v-on:input="setOption()"  />
                <input id="nodeid" style="display: none;"  autocomplete="off" />
            </div>

            <!--下拉选择 -->
            <div style="" >
                <div id="select" style="border-radius:5px;display:none;border:1.2px solid #4876FF;margin-top: 30x;width:150px;overflow-x: auto;white-space: nowrap;">
                    ...
                    <ul v-for="node in nodeData"  id="selectUl" style="margin:0; padding:5px; text-align:left;">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setOption(){//
                    this.page=0;
                    var obj = document.getElementById("sousu")
                    ...
                    document.getElementById("select").style.left=inputOffsetLeft;
                    document.getElementById("select").style.top=inputOffsetTop+130;
                    $("#select").show();
                    //
            ...
            getValue(nodename,nodeid){//获取选中的值
