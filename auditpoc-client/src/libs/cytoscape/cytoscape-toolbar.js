            ...
            [
                {
                    ...
                    tooltip: '放大', // value for the title attribute of a span element
                ...
                init: function () {
                    ...
                    var bindings = {
                        on: function (event, selector, action) {
                            ...
                            // // }
                            //
                            // cy.on(event,selector,function (event) {
                    ...
                    function addEventListeners() {
                        $('.ui-cytoscape-toolbar .tool-item-list-wrapper').each(function (index) {
                            var eventData = {
                                data: data,
                                handlerIndex: index,
                                canPerform: function () {
                            ...
                            $(this).on('click', function (event) {
                                ...
                                event.cy = data.cy;
                                options.tools[index][0].action[0](event);
                            });
                        });
